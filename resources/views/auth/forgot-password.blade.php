...
<head>
    ...
    <title>Forgot Password | Desa Gadel</title>
</head>
                ...
                <div class="card smooth-shadow-md">
                    <div class="card-body p-6">
                        <div class="mb-4 text-center">
                            <p class="mb-6" style="color: #28a745; font-size: 24px; font-weight: bold;">Lupa Kata
                                Sandi</p>
                        </div>
                            ...
                            <div class="mb-3 d-grid mt-4">
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary"
                                        style="background-color: #28a745; border-color: #28a745; transition: background-color 0.3s ease, border-color 0.3s ease;"
